 ...
 * @author CAMARGO
 */
public class Calculadora_Soma_Subtracao extends javax.swing.JFrame {

    /**
     * Creates new form Calculadora
     */
    public Calculadora_Soma_Subtracao() {
        initComponents();
        Desabilitar();
        Habilitar();
    }
...
txt_n1.setEditable(true); txt_n2.setEditable(true); txt_res.setEditable(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Calculadora_Soma_Subtracao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Calculadora_Soma_Subtracao().setVisible(true);
            }
